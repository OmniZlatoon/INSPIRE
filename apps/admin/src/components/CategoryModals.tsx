    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6 bg-black/60 backdrop-blur-md">
            <div className="bg-[#f8f9fa] dark:bg-[#0a0a0a] rounded-xl w-[90vw] max-w-7xl shadow-2xl flex flex-col h-[90vh] overflow-hidden">
                        ...
                        <div className="space-y-6 max-w-xl mx-auto">
                            ...
                            <div>
                                ...
                                <div className="space-y-4 p-5 bg-white dark:bg-[#1a1a1a] rounded-2xl border border-gray-200 dark:border-[#2E2E2E]">
                                    ...
                                    <hr className="border-gray-100 dark:border-[#2E2E2E]" />
                                    <div>
                                ...
                                <div className="space-y-3">
                                    {form.whatYouWillLearn.map((item, idx) => (
                                        <div key={idx} className="flex gap-2">
                                            ...
                                            }} className="p-3 bg-white dark:bg-[#1a1a1a] border border-gray-200 dark:border-[#2E2E2E] rounded-xl text-red-500 hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors"><X size={18} /></button>
                                        </div>
                                    ))}
                                        ...
                                        <div className="mt-4 pt-4 border-t border-gray-100 dark:border-[#2E2E2E]">
                                            ...
                                            <div className="flex flex-wrap gap-2">
                                                {form.skills.map(skill => (
                                                    <span key={skill} className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-[#e8f0fe] dark:bg-blue-900/20 text-[#1a73e8] dark:text-blue-400 rounded-lg text-xs font-medium border border-gray-200 dark:border-[#2E2E2E]">
                            ...
                            <div>
                                ...
                                <div className="space-y-3">
                                    {form.partners.map((p, idx) => (
                                        <div key={idx} className="flex items-center gap-4 p-4 bg-white dark:bg-[#1a1a1a] rounded-2xl border border-gray-200 dark:border-[#2E2E2E]">
                                            {p.logoUrl ? (
                                                <img src={p.logoUrl} alt={p.name} className="w-12 h-12 rounded bg-white object-contain border border-gray-100 dark:border-[#2E2E2E]" />
                                            ) : (
                                    ...
                                    {!isAddingPartner ? (
                                        <button type="button" onClick={() => setIsAddingPartner(true)} className="w-full flex items-center justify-center gap-2 py-3 border border-dashed border-gray-300 dark:border-[#2E2E2E] rounded-2xl text-[#5f6368] hover:bg-gray-50 dark:hover:bg-[#1a1a1a] transition-colors text-sm font-medium">
                                        ...
                                        <div className="p-5 bg-white dark:bg-[#1a1a1a] rounded-2xl border border-primary/30 space-y-4">
                                            ...
                                            <div className="flex items-center gap-4">
                                                <label className="flex-shrink-0 cursor-pointer w-16 h-16 rounded-xl border border-dashed border-gray-300 dark:border-[#2E2E2E] flex flex-col items-center justify-center bg-gray-50 dark:bg-[#121212] hover:bg-gray-100 dark:hover:bg-[#2d2d2d] transition-colors relative overflow-hidden">
                                                    {partnerLogoPreview ? (
                            ...
                            <div>
                                ...
                                <div className="space-y-4">
                                    {form.faqs.map((faq, idx) => (
                                        <div key={idx} className="p-5 bg-white dark:bg-[#1a1a1a] rounded-2xl border border-gray-200 dark:border-[#2E2E2E] space-y-3 relative group">
                                            <button type="button" onClick={() => {
                ...
                <div className="p-4 sm:p-6 bg-white dark:bg-[#1a1a1a] border-t border-gray-200 dark:border-[#2E2E2E] flex justify-end gap-3 flex-shrink-0 z-10">
...
export function DeleteCategoryModal({ category, onClose, onConfirm, isLoading }: { category: Category; onClose: () => void; onConfirm: () => void; isLoading: boolean }) {
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
            <div className="bg-white dark:bg-[#1e1e1e] rounded-2xl w-full max-w-md p-6 shadow-2xl border border-red-100 dark:border-[#2E2E2E]">
            ...
            <div className="bg-white dark:bg-[#111] rounded-2xl w-[80vw] max-h-[88vh] shadow-2xl flex flex-col overflow-hidden border border-gray-200 dark:border-[#2E2E2E]">
                ...
                <div className="flex-1 overflow-y-auto p-8">
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                                ...
                                {category.partners?.length > 0 ? (
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                        {category.partners.map((p, i) => (
                                            <div key={i} className="flex items-center gap-4 p-4 border border-gray-100 dark:border-[#2E2E2E] rounded-xl bg-white dark:bg-[#1a1a1a]">
                                                {p.logoUrl ? (
                        ...
                        <div className="space-y-8 bg-gray-50/40 dark:bg-[#0d0d0d] p-6 rounded-2xl border border-gray-100 dark:border-[#2E2E2E]">
                            <section>
                                ...
                                {category.specializationIds?.length > 0 ? (
                                    <div className="flex flex-wrap gap-2">
                                        {category.specializationIds.map(id => {
                                            ...
                                            return <span key={id} className="text-xs px-3 py-1.5 bg-white dark:bg-[#1a1a1a] border border-gray-200 dark:border-[#2E2E2E] rounded-lg text-[#3c4043] dark:text-gray-300 font-medium">{s?.name || id}</span>;
                                        })}
                                    </div>
                                ) : <p className="text-sm text-gray-400 italic">None linked.</p>}
                            </section>
